...
module.exports = function (app, protoModels) {
	app.log.verbose("socket_protobuf: Augmenting the models pub broadcast method to serialize models");
	for (var identity in app.models) {
		...
		app.log.silly("socket_protobuf: Will augment", identity, "model's broadcast to use proto message scheme named", protobufSchemeName);
